...
worksheet = openpyxl.load_workbook("C:\\Users\\HP\\PycharmProjects\\pratice_session\\Verynew\\TestData\\Login.xlsx")
...
class ExcelMethods(BaseData):
    ...
    def update_result_in_excel(self,s_no,status):
        ...
        worksheet.save("C:\\Users\\HP\\PycharmProjects\\pratice_session\\Verynew\\TestData\\Login.xlsx")
